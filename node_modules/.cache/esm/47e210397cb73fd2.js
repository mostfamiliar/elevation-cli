_7cb‍.x([["validateApiKey",()=>validateApiKey],["queryTerrainVectorTileset",()=>queryTerrainVectorTileset]]);const fetch = require('node-fetch');
  ...
  return true;
       ...
       async function queryTerrainVectorTileset(lon, lat, apiKey) {
